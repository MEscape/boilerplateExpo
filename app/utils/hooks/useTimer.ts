...
export const useInterval = creteUseTimer(clearInterval as ClearTimerFn, setInterval)
export const useTimeout = creteUseTimer(clearTimeout as ClearTimerFn, setTimeout)
